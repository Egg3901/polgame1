...
$con = OpenCon();
$state_data_query = 'SELECT name, population, govtime, wmcvotershare, wmctotalappeal, wmcecon, wmcsocial     $result = $stmt->bind_result($state_name,$state_population,$gov_time_remaining, $wmc_voter_share, $wmc_total_appeal, $wmc_econ, $wmc_social);';
